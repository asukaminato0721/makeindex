...
static mut first_entry: i32 = 1_i32;
...
pub unsafe extern "C" fn scan_idx() {
    ...
    let mut c: i32 = 0;
    let mut i: i32 = 0_i32;
    let mut not_eof: i32 = 1_i32;
    let mut arg_count: i32 = -1_i32;
    if verbose != 0 {
        fprintf(
            stderr,
            ...
            _ => match arg_count {
                ...
                0 => {
                    if c == idx_aopen as i32 {
                        ...
                        if strcmp(keyword.as_mut_ptr(), idx_keyword.as_mut_ptr()) == 0_i32 {
                            if scan_arg1() == 0 {
                                arg_count = -1_i32;
                            }
                        } else {
...
unsafe extern "C" fn make_key() -> i32 {
    ...
    (*ptr).data.lpg[0_i32 as usize] = '\0' as i32 as libc::c_char;
    (*ptr).data.count = 0_i32 as libc::c_short;
    (*ptr).data.type_0 = -9999_i32 as libc::c_short;
    if scan_key(&mut (*ptr).data) == 0 {
        return 0_i32;
    }
    (*ptr).data.group = group_type((*ptr).data.sf[0_i32 as usize]);
...
unsafe extern "C" fn make_string(mut ppstr: *mut *mut libc::c_char, mut n: i32) {
    if *(*ppstr).offset(0_i32 as isize) as i32 == '\0' as i32 {
        ...
        *(*ppstr).offset(0_i32 as isize) = '\0' as i32 as libc::c_char;
    }
}
unsafe extern "C" fn scan_key(mut data: FIELD_PTR) -> i32 {
    let mut i: i32 = 0_i32;
    let mut n: i32 = 0_i32;
    let mut second_round: i32 = 0_i32;
    let mut last: i32 = 3_i32 - 1_i32;
    while key[n as usize] as i32 != '\0' as i32 {
        if key[n as usize] as i32 == idx_encap as i32 {
            ...
            make_string(
                &mut (*data).encap,
                (strlen(key.as_mut_ptr())).wrapping_add(1_i32 as libc::c_ulong) as i32,
            );
            if scan_field(
                &mut n,
                (*data).encap,
            ...
            if german_sort != 0 && !(strchr((*data).sf[i as usize], '"' as i32)).is_null() {
                make_string(
                    &mut *((*data).af).as_mut_ptr().offset(i as isize),
                    (strlen((*data).sf[i as usize])).wrapping_add(1_i32 as libc::c_ulong) as i32,
                );
                search_quote((*data).sf[i as usize], (*data).af[i as usize]);
            }
        }
    }
    if *(*data).sf[0_i32 as usize] as i32 == '\0' as i32 {
        if idx_dot != 0 {
            fprintf(ilg_fp, b"\n\0" as *const u8 as *const libc::c_char);
            idx_dot = 0_i32;
        }
    ...
    while i < 3_i32 - 1_i32 {
        if *(*data).sf[i as usize] as i32 == '\0' as i32
            && (*(*data).af[i as usize] as i32 != '\0' as i32
                || *(*data).sf[(i + 1_i32) as usize] as i32 != '\0' as i32)
        {
            if idx_dot != 0 {
                fprintf(ilg_fp, b"\n\0" as *const u8 as *const libc::c_char);
                idx_dot = 0_i32;
    ...
    loop {
        ...
        if current_block == 10886091980245723256 {
                ...
                || key[*n as usize] as i32 == '\0' as i32
            {
                if i > 0_i32
                    && compress_blanks != 0
                    && *field.offset((i - 1_i32) as isize) as i32 == ' ' as i32
                {
                    *field.offset((i - 1_i32) as isize) = '\0' as i32 as libc::c_char;
                } else {
...
pub unsafe extern "C" fn group_type(mut str: *mut libc::c_char) -> i32 {
    ...
    if *str.offset(i as isize) as i32 == '\0' as i32 {
        ...
        i
    } else if '!' as i32 <= *str.offset(0_i32 as isize) as i32
        && *str.offset(0_i32 as isize) as i32 <= '@' as i32
        || '[' as i32 <= *str.offset(0_i32 as isize) as i32
            && *str.offset(0_i32 as isize) as i32 <= '`' as i32
        || '{' as i32 <= *str.offset(0_i32 as isize) as i32
            && *str.offset(0_i32 as isize) as i32 <= '~' as i32
    {
...
unsafe extern "C" fn scan_no(
    ...
    let mut i: i32 = 1_i32;
    if *(*__ctype_b_loc()).offset(*no_0.offset(0_i32 as isize) as i32 as isize) as i32
        & _ISdigit as i32 as libc::c_ushort as i32
        != 0
    {
        *type_0 = 2_i32 as libc::c_short;
        if scan_arabic(no_0, npg, count) == 0 {
            return 0_i32;
        }
    } else if (*no_0.offset(0_i32 as isize) as i32 == 'i' as i32
        || *no_0.offset(0_i32 as isize) as i32 == 'v' as i32
        || *no_0.offset(0_i32 as isize) as i32 == 'x' as i32
        || *no_0.offset(0_i32 as isize) as i32 == 'l' as i32
        || *no_0.offset(0_i32 as isize) as i32 == 'c' as i32
        || *no_0.offset(0_i32 as isize) as i32 == 'd' as i32
        || *no_0.offset(0_i32 as isize) as i32 == 'm' as i32)
        && (strncmp(
        ...
        ) != 0_i32)
    {
        *type_0 = 0_i32 as libc::c_short;
        ...
        || *no_0.offset(0_i32 as isize) as i32 == 'D' as i32
        || *no_0.offset(0_i32 as isize) as i32 == 'M' as i32)
        && (*no_0.offset(0_i32 as isize) as i32 == 'I' as i32
            || (strncmp(
                &mut *no_0.offset(i as isize),
                page_comp.as_mut_ptr(),
                comp_len as libc::c_ulong,
    ...
    {
        *type_0 = 1_i32 as libc::c_short;
        if scan_roman_upper(no_0, npg, count) == 0 {
            return 0_i32;
        }
    } else if 'a' as i32 <= *no_0.offset(0_i32 as isize) as i32
        && *no_0.offset(0_i32 as isize) as i32 <= 'z' as i32
    {
        *type_0 = 3_i32 as libc::c_short;
...
unsafe extern "C" fn scan_arabic(
    ...
    *npg.offset(*count as isize) =
        (strtoint(str.as_mut_ptr()) + page_offset[2_i32 as usize]) as libc::c_short;
    *count += 1;
    *count;
    if strncmp(
        &mut *no_0.offset(i as isize),
...
unsafe extern "C" fn scan_roman_lower(
    ...
    *npg.offset(*count as isize) = (inp + page_offset[0_i32 as usize]) as libc::c_short;
    *count += 1;
    *count;
    if strncmp(
        &mut *no_0.offset(i as isize),
...
unsafe extern "C" fn scan_roman_upper(
    ...
    *npg.offset(*count as isize) = (inp + page_offset[1_i32 as usize]) as libc::c_short;
    *count += 1;
    *count;
    if strncmp(
        &mut *no_0.offset(i as isize),
...
unsafe extern "C" fn scan_alpha_lower(
    ...
    *npg.offset(*count as isize) = ((if 'A' as i32 <= *no_0.offset(0_i32 as isize) as i32
        && *no_0.offset(0_i32 as isize) as i32 <= 'Z' as i32
    {
        *no_0.offset(0_i32 as isize) as i32 - 'A' as i32
    } else if 'a' as i32 <= *no_0.offset(0_i32 as isize) as i32
        && *no_0.offset(0_i32 as isize) as i32 <= 'z' as i32
    {
        *no_0.offset(0_i32 as isize) as i32 - 'a' as i32
        ...
        0_i32
    }) + page_offset[3_i32 as usize]) as libc::c_short;
    *count += 1;
    *count;
    i = 1_i32 as libc::c_short;
    if strncmp(
        &mut *no_0.offset(i as isize),
        page_comp.as_mut_ptr(),
        comp_len as libc::c_ulong,
    ...
    {
        scan_no(
            &mut *no_0.offset((comp_len + 1_i32) as isize),
            npg,
            count,
            &mut i,
        )
    ...
    *npg.offset(*count as isize) = ((if 'A' as i32 <= *no_0.offset(0_i32 as isize) as i32
        ...
        && *no_0.offset(0_i32 as isize) as i32 <= 'z' as i32
    {
        *no_0.offset(0_i32 as isize) as i32 - 'a' as i32
        ...
        0_i32
    }) + page_offset[4_i32 as usize]) as libc::c_short;
    *count += 1;
    *count;
    i = 1_i32 as libc::c_short;
    if strncmp(
...
unsafe extern "C" fn scan_arg1() -> i32 {
    ...
    while i < 1024_i32 && a != -1_i32 {
        if a == idx_quote as i32 || a == idx_escape as i32 {
            ...
            if n == 0_i32 {
                if compress_blanks != 0 && key[(i - 1_i32) as usize] as i32 == ' ' as i32 {
                    key[(i - 1_i32) as usize] = '\0' as i32 as libc::c_char;
                } else {
            ...
            match a {
                ...
                9 | 32 => {
                    if compress_blanks != 0 {
                        if i > 0_i32
                            && key[(i - 1_i32) as usize] as i32 != ' ' as i32
                            && key[(i - 1_i32) as usize] as i32 != '\t' as i32
                        {
                            let fresh12 = i;
                            i += 1;
...
unsafe extern "C" fn search_quote(
    ...
    while !ptr.is_null() {
        ...
        match *ptr.offset(1_i32 as isize) as i32 {
            97 | 65 => {
                sort = (if *(*__ctype_b_loc())
                    .offset(*ptr.offset(1_i32 as isize) as i32 as isize)
                    as i32
        ...
        if *sort.offset(0_i32 as isize) as i32 != '\0' as i32 {
            char_found = 1_i32;
            *ptr = *sort.offset(0_i32 as isize);
            *ptr.offset(1_i32 as isize) = *sort.offset(1_i32 as isize);
        }
        ptr = strchr(ptr.offset(1_i32 as isize), '"' as i32);
    }
    if char_found == 0 {
        *actual_key.offset(0_i32 as isize) = '\0' as i32 as libc::c_char;
    }
}
